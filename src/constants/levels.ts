...
export const TIER_DEFINITIONS: TierDefinition[] = [
  {
    ...
    color: '#00ffff',
    platformTypes: ['static', 'static', 'static', 'crumble', 'ice'],
    enemySpawnBase: 0.12,
    enemySpeedMult: 1.1,
  ...
  },
  {
    ...
    color: '#39FF14',
    platformTypes: ['static', 'static', 'crumble', 'horizontal', 'vertical', 'ice', 'bounce'],
    enemySpawnBase: 0.28,
    enemySpeedMult: 1.35,
  ...
  },
  {
    ...
    color: '#ffcc00',
    platformTypes: ['static', 'crumble', 'horizontal', 'vertical', 'rotating', 'phasing', 'ice', 'bounce', 'spiral', 'fragile'],
    enemySpawnBase: 0.45,
    enemySpeedMult: 1.65,
    minPlatformWidth: 90,
  ...
  },
  {
    ...
    color: '#ff6600',
    platformTypes: ['crumble', 'horizontal', 'vertical', 'rotating', 'phasing', 'ice', 'bounce', 'spiral', 'fragile'],
    enemySpawnBase: 0.62,
    enemySpeedMult: 2.0,
    minPlatformWidth: 70,
  ...
  },
  {
    ...
    color: '#ff2244',
    platformTypes: ['crumble', 'horizontal', 'vertical', 'rotating', 'phasing', 'ice', 'bounce', 'spiral', 'fragile', 'phasing'],
    enemySpawnBase: 0.78,
    enemySpeedMult: 2.4,
    minPlatformWidth: 55,
    ...
    maxYGap: 300,
    challengeGapEvery: 2,
    challengeGapSize: 480,
    midAirEnemyChance: 0.7,
    comboCooldown: 260,
  },
];
